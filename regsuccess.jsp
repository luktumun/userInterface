...
<head>
    <meta charset="utf-8">
    <title>Sign Up Successful | FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
   ...
   <p>
    ...
    <p style="color:#6495ED">You have successfully signed up<br>with football club&nbsp;doodhwa</p>
   <p style="color:#6495ED">Your credentials userId and password <br>has been sent to your&nbsp;email. Thank you!</p>
    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>
