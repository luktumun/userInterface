...
<head>
    <meta charset="utf-8">
    <title>Reset Password successfully| FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
  ...
  <p>
    ...
    <p style="color:#6495ED">Password updated  &nbsp;successfully!</p>

    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>

    <div class="loginBox">
	<p style="color:#6495ED">To login<br>with football club&nbsp;doodhwa. click Sign In</p>
