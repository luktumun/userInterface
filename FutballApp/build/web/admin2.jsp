...
<head>
    <meta charset="utf-8">
    <title>Admin access failed | FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
   ...
   <p>
    ...
    <p style="color:#6495ED">Sorry! <br>Event Details upload failed! please upload a valid file. &nbsp;Size of the file must be less than 1 MB. </p>

    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>

    <div class="loginBox">
	<p style="color:#6495ED">To Sign In<br>with football club&nbsp;doodhwa. click Sign In</p>
         
    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>
       <a style="color:#67736f" class="left accountLink link" href="login.jsp">Sign In</a></br>
    <p style="color:#6495ED">If you forgot<br>your userid or password&nbsp;please! click Forgot password</p>
