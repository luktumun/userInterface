...
<head>
    <meta charset="utf-8">
    <title>Error with sign Up| FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
    ...
    <p style="color:#6495ED">Your Sign Up<br>with football club&nbsp;doodhwa was unsuccessful.<br/>Please try again with another email</p>

    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>

    <div class="loginBox">
	<p style="color:#6495ED">To Sign Up<br>with football club&nbsp;doodhwa. click Sign Up</p>
         
    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>
      <a style="color:#67736f" class="forgotpw link" href="register.jsp">Sign Up</a></br>
