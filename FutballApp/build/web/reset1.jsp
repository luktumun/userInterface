...
<head>
    <meta charset="utf-8">
    <title>Error with Reset Password | FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
    ...
    <p style="color:#6495ED">Updating Password<br>failed. Both password fields must be&nbsp;same!</p>

    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>

    <div class="loginBox">
	<p style="color:#6495ED">To try again<br>with football club&nbsp;doodhwa. click Sign In</p>
