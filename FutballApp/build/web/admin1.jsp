...
<head>
    <meta charset="utf-8">
    <title>Admin access successfull | FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
    ...
    <p style="color:#6495ED">Upcoming Event details uploaded<br>successfully. &nbsp;please login to see upcoming events. </p>
