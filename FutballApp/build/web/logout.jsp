...
<head>
    <meta charset="utf-8">
    <title>Sign Out | FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
  ...
  <p>
    ...
    <p style="color:#6495ED">You have successfully Signed Out<br>from football club&nbsp;doodhwa.</p>

    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>

    <div class="loginBox">
	<p style="color:#6495ED">To login again<br>with football club&nbsp;doodhwa. click Sign In</p>
         
    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>
      <a style="color:#67736f" class="forgotpw link" href="login.jsp">Sign In</a>
