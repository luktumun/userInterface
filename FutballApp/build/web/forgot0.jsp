...
<head>
    <meta charset="utf-8">
    <title>Error with Forgot Password | FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
   ...
   <p>
    ...
    <p style="color:#6495ED">Sending your credentials userId and Password <br>to your email &nbsp;failed!</p>

    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>

    <div class="loginBox">
	<p style="color:#6495ED">To try again<br>with football club&nbsp;doodhwa. click Forgot Password</p>
         
    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>
      <a style="color:#67736f" class="left accountLink link" href="forgotpassword.jsp">Forgot Password</a></br>
  <p style="color:#6495ED">To Sign In<br>with football club&nbsp;doodhwa. click Sign In</p>
   
    <div class="message-bar ta-center">
        <div id="errorBar" class="messageBar error"></div>        <div id="infoBar" class="messageBar info"></div>    </div>
    <a style="color:#67736f" class="forgotpw link" href="login.jsp">Sign In</a></br>
    </div>
</div>
