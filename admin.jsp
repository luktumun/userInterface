...
<head>
    <meta charset="utf-8">
    <title>Admin | FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
	...
	<p style="color:#6495ED"> <%=new Date()%></br> </p>
		...
		<p style="color:#6495ED"><b>Hi!  <%= user.getFirstName() + " " + user.getLastName()%></b><br/>
		 Enter details<br>for upcoming events for football club&nbsp;doodhwa.</p>
			 <br/>	 
    ...
    <div class="loginBox">
        <form method="POST" action="AdminServlet" id="loginForm" novalidate>
  
	<input type="hidden" name="email" value="<%=user.getEmail()%>">
        
        <input type="text" class="mb20" name="eventName" id="eventDate" placeholder="Event Name">
        
        <input type="date" class="mb20" name="eventDate" id="eventDate" placeholder="Event Date">
        
	<input type="text" class="mb20" name="upcomingEvents" id="upcomingEvents" placeholder="Upcoming event link">
