...
<head>
    <meta charset="utf-8">
    <title>Error with sign in | FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
    ...
    <p style="color:#6495ED">Your Sign In<br>with football club&nbsp;doodhwa was unsuccessful</p>
