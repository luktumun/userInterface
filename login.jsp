...
<head>
    <meta charset="utf-8">
    <title>Sign In | FootballClubDoodhwa</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
   ...
   <p>
    ...
    <p style="color:#6495ED">Sign In to visit<br>football club&nbsp;doodhwa.</p>
   ...
   <a style="color:#67736f" href="register.jsp" class="left accountLink link">Sign Up</a>

    <button style="color:#67736f" id="loginButton" class="right link greyed-out" type="submit">Sign In</button>
