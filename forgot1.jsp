...
<head>
    <meta charset="utf-8">
    <title>Password sent successfully| FCD</title>    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sign-in-box container_12">
   ...
   <p>
    ...
    <p style="color:#6495ED">Your credential to Sign In<br>with football club doodhwa has been sent &nbsp;successfully to your email.</p>
